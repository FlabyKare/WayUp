...
let result = `${array[4]} ${array[8]} ${array[1]} ${array[9]} ${array[12]} ${array[6]} ${array[10]} ${array[7]} ${array[5]} ${array[2]} ${array[13]} ${array[3]} ${array[11]}`
...
//https://disk.yandex.ru/d/8u3oDU1Qv23vcA         2 урок